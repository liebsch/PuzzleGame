...
#pragma warning restore 618
        ...
        protected virtual void SnapObject(VRTK_InteractableObject interactableObjectCheck)
        {
            ...
            {
//Edit by Laurin 
                //Set a range, which the Cube has to be, to fit in the SnapArea
...
//Edit by Laurin
            float x = ioTransform.eulerAngles.x;
            float y = ioTransform.eulerAngles.y;
            float z = ioTransform.eulerAngles.z;
            
            //Set the right rotaion of the x variable
            if(45.0f <= x &&  x  < 135.0f){
                x = 90.0f;          
                }
            else if(135.0f <= x  &&  x  < 225.0f){
                x = 180.0f;
            }
            else if(225.0f <= x  &&  x < 315.0f){
                x = 270.0f;
            }
            else {  
                x = 360.0f;
            ...
            //Set the right rotaion of the y variable
            if(45.0f <= y &&  y  < 135.0f){
                y = 90.0f;              
                }
            else if(135.0f <= y  &&  y  < 225.0f){
                y = 180.0f; 
            }
            else if(225.0f <= y  &&  y < 315.0f){
                y = 270.0f; 
            }
            else {   
                y = 360.0f; 
            ...
            //Set the right rotaion of the z variable
            if(45.0f <= z &&  z  < 135.0f){
                z = 90.0f;              
                }
            else if(135.0f <= z  &&  z  < 225.0f){
                z = 180.0f; 
            }
            else if(225.0f <= z  &&  z < 315.0f){
                z = 270.0f; 
            }
            else {   
                z = 360.0f; 
            ...
            rightRotation = Quaternion.Euler(x, y, z);
...
//End
            ...
            while (elapsedTime <= duration)
            {
                ...
                if (ioTransform != null && endSettings != null)
                {
                    ...
                    ioTransform.rotation = Quaternion.Lerp(startRotation, rightRotation, (elapsedTime / duration));
//Edit by Laurin                    
...
//End 
            ...
            if (ioTransform != null && endSettings != null)
            {
                ...
                ioTransform.rotation = rightRotation;
//Edit by Laurin
